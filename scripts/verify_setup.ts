...
async function verify() {
    ...
    if (connError && connError.code !== "PGRST202") { // Function not found is fine, connection is what matters
        // Try simple select
    ...
    if (colError) {
        console.error("❌ Column 'recurrence_rule' missing in 'tasks'. Migration 0009 might have failed.");
    } else {
