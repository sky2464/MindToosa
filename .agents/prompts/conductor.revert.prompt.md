...
2.  **Identify Associated Plan-Update Commits:**
    - For each validated implementation commit, use `git log` to find the corresponding plan-update commit that happened _after_ it and modified the relevant `plan.md` file.
