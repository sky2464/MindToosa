    ...
    return (
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-50 md:top-0 md:bottom-auto md:left-0 md:right-auto md:h-screen md:w-16 md:flex md:flex-col md:items-center md:py-6">
                {/* Mobile bottom bar */}
                <div className="relative flex md:hidden w-full border-t border-white/5 bg-zinc-950/90 backdrop-blur-xl">
                    {/* Scroll indicators */}
                    <div className="pointer-events-none absolute left-0 top-0 bottom-0 z-10 w-4 bg-gradient-to-r from-zinc-950 to-transparent"></div>
                    <div className="pointer-events-none absolute right-0 top-0 bottom-0 z-10 w-4 bg-gradient-to-l from-zinc-950 to-transparent"></div>

                    <div className="flex w-full items-center justify-start overflow-x-auto px-2 py-2 no-scrollbar">
                        <button
                        ...
                        {navItems.map(({ href, label, icon: Icon }) => {
                            ...
                            return (
                                <Link
                                    key={href}
                                    href={href}
                                    className={`flex flex-col items-center gap-1 px-3 py-1.5 rounded-xl transition-all flex-shrink-0 ${isActive
                                        ? "text-indigo-400"
                ...
                {/* Desktop sidebar */}
                <div className="hidden md:flex flex-col items-center gap-2 h-full border-r border-white/5 bg-zinc-950/80 backdrop-blur-xl w-16 py-6 overflow-y-auto">
