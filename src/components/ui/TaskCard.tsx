...
export function TaskCard({ task, index, onDragStart, onEdit, isDraggable = true }: TaskCardProps) {
  return (
    <div
      ...
      className={`group relative cursor-grab rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 transition-all hover:translate-x-1 hover:border-zinc-700 hover:bg-zinc-800 active:cursor-grabbing z-[var(--z-index,calc(10-${index}))] ${
        index === 0
