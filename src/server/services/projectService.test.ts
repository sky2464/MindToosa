...
describe("projectService", () => {
  ...
  describe("createProject", () => {
    ...
    it("should throw ValidationError on invalid data", async () => {
      await expect(projectService.createProject(userId, { title: "" })).rejects.toThrow(
        ValidationError
      );
    });
  });
  ...
  describe("updateProject", () => {
    it("should validate UUID", async () => {
      await expect(projectService.updateProject(userId, "invalid", {})).rejects.toThrow(
        ValidationError
      );
    });
  ...
  describe("deleteProject", () => {
    it("should validate UUID", async () => {
      await expect(projectService.deleteProject(userId, "invalid")).rejects.toThrow(
        ValidationError
      );
    });
  });
