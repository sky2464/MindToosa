...
export default function SettingsPage() {
    ...
    useEffect(() => {
        // Load AI toggle from localStorage
    ...
    return (
        <div className="min-h-screen p-6 pb-24 max-w-2xl mx-auto md:ml-20">
            ...
            <div className="space-y-4">
                ...
                <section className="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="font-medium text-white">{userEmail ?? "Loading..."}</p>
                ...
                <section className="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-6">
                    ...
                    <p className="mb-4 text-sm text-zinc-500">
                        Your data is stored securely in Supabase. Only the minimum context is sent to the AI model when planning is enabled.
                    </p>
                    <button
                        disabled
                        className="flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-800/30 px-4 py-2 text-sm text-zinc-600 cursor-not-allowed"
                        title="Coming soon"
                    >
                        <Download size={16} />
