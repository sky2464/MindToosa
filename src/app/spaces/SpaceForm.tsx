  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <h3 className="text-xs font-bold tracking-widest text-zinc-500 uppercase">Custom Space</h3>
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-zinc-700 bg-zinc-900/50 px-4 py-2.5 text-sm text-white placeholder-zinc-600 transition outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30"
          />
          <button
            type="submit"
