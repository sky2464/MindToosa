    ...
    <div className="group flex flex-col gap-1 rounded-2xl border border-zinc-800 bg-zinc-900/40 px-5 py-4 transition-all hover:border-zinc-700 hover:bg-zinc-900/60">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {space.archived && (
            <span className="rounded-full border border-zinc-700 bg-zinc-800 px-2 py-0.5 text-[10px] font-medium tracking-wider text-zinc-500 uppercase">
              Archived
            </span>
          )}
        </div>
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs text-zinc-600 opacity-0 transition-all group-hover:opacity-100 hover:bg-zinc-800 hover:text-zinc-300 disabled:opacity-50"
        >
          {loading ? (
