...
export default async function SpacesPage() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-4xl p-4 pb-24 sm:p-6 lg:p-8">
      <header className="mb-10 space-y-1">
        <Link
          href="/"
          className="group mb-4 flex items-center gap-2 text-sm text-zinc-500 transition hover:text-white"
        >
          ← Back
        </Link>
        ...
        <p className="text-zinc-500">
          Separate contexts for different areas of your life. Tasks and goals stay organized within
          each space.
        </p>
      </header>
