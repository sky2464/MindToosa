...
export default async function WeekPage() {
  ...
  const allTasks = [
    ...weekTasks,
    ...pastIncompleteCandidates.filter((t) => !weekTasks.some((wt) => wt.id === t.id)),
  ];
  ...
  return (
    <div className="mx-auto min-h-screen max-w-6xl p-4 pb-24 sm:p-6 lg:p-8">
            ...
            >
              ...
              {dayTasks.length === 0 ? (
                ...
                <div className="space-y-1.5">
                  {pendingTasks.map((task) => (
                    ...
                    >
                      ...
                      <div className="mt-1 flex flex-wrap items-center gap-1">
                        ...
                        {task.series_id && (
                          <span
                            className="inline-flex items-center gap-0.5 rounded-full bg-indigo-500/10 px-1.5 py-0.5 text-[9px] text-indigo-400"
                  ...
                  {doneTasks.length > 0 && (
                    <p className="text-[10px] text-emerald-600">✓ {doneTasks.length} done</p>
                  )}
                </div>
              )}
            </div>
